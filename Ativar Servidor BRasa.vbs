...
scriptPath = fso.BuildPath(root, "scripts\start-brasa-network.ps1")
...
If process.ExitCode = 0 Then
    If output = "" Then output = "Servidor BRasa ativo na rede."
    MsgBox output, 64, "BRasa"
Else
    If errors = "" Then errors = output
    If errors = "" Then errors = "Nao foi possivel iniciar o servidor BRasa."
