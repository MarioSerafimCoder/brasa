...
sealed interface UpdateUiState{data object Idle:UpdateUiState;data object Checking:UpdateUiState;data object UpToDate:UpdateUiState;data class Available(val update:UpdateManifest):UpdateUiState;data class Downloading(val update:UpdateManifest,val percent:Int):UpdateUiState;data class Validating(val update:UpdateManifest):UpdateUiState;data class Ready(val update:UpdateManifest,val apkPath:String):UpdateUiState;data class Error(val message:String,val update:UpdateManifest?=null):UpdateUiState}
