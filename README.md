...
As playlists ficam em `data/prepared-media/hls`, usam segmentos de aproximadamente dois segundos e nunca substituem o original. A reprodução sob demanda começa com uma única variante: 480p para HDR que exige tone mapping por CPU ou até 1080p para SDR. Remux mantém a resolução original. Ao retomar, a sessão HLS começa perto da posição salva e o APK preserva a linha do tempo absoluta do filme. Playlists em processamento não recebem cache agressivo e segmentos finalizados podem ser reutilizados.
