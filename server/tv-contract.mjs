...
export function normalizeTvCatalogItem(value) {
    ...
    return {
        ...
        franchise: stringValue(item.franchise),
        ...
        inMyList: booleanValue(item.inMyList || item.favorite),
        completed: booleanValue(item.completed),
        newEpisode: booleanValue(item.newEpisode),
        resumeMediaKey: stringValue(item.resumeMediaKey),
        actionLabel: stringValue(item.actionLabel),
        recommendationReason: stringValue(item.recommendationReason),
        searchHint: stringValue(item.searchHint),
        reaction: stringValue(item.reaction),
        hiddenSuggestion: booleanValue(item.hiddenSuggestion),
        remainingMinutes: integerOrNull(item.remainingMinutes),
